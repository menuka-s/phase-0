...
// Well first, I confused new objects for creating classes, so that was a little confusing haha, once I took a step back this challenge was fine.
// However, I had trouble on creating the children object. At first it didn't click that I had to create a new object then add the child and set that equal to a new object. I was originally trying different ways of creating objects called "Carson", etc. and adding those in, but that didn't work.

// How difficult was it to add and delete properties outside of the object itself?
// Not too hard after the initial confusion. It is pretty similar to other programming languages. 

// What did you learn about manipulating objects in this challenge?
// How to create nested objects that can hold different forms of data. It is pretty easy to create new properties in objects.
